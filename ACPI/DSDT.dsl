 ...
 *
 * Disassembly of DSDT.aml, Sat Oct 10 16:54:20 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000217A2 (137122)
 *     Revision         0x02
 *     Checksum         0x43
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SKL     "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    External (_SB_.PCI0.LPCB.EC__.HKEY.DEVT, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.LPCB.H_EC.XDAT, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.MLTR, UnknownObj)
    External (_SB_.PCI0.PAUD.PUAM, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.PEG0, DeviceObj)
    External (_SB_.PCI0.PEG0.DGIZ, UnknownObj)
    External (_SB_.PCI0.PEG0.MASP, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.PEG0.PEGP, DeviceObj)
    External (_SB_.PCI0.PEG0.PEGP.HDAS, UnknownObj)
    External (_SB_.PCI0.PEG0.PEGP.LCD0, DeviceObj)
    External (_SB_.PCI0.PEG0.PEGP.MASP, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.PEG0.PEGP.NVST, MethodObj)    // 0 Arguments
    ...
    Name (SS4, One)
    One
    OperationRegion (GNVS, SystemMemory, 0x9954F000, 0x072C)
    ...
    Scope (\_SB.PCI0.I2C0)
    {
        Device (TPD0)
        {
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If (((SDS0 == 0x05) || ((SDS0 == 0x01) || (SDS0 == 0x02))))
                {
                    Return (0x0F)
                }
    ...
    Scope (\_SB.PCI0.LPCB)
    {
        Device (EC)
        {
            ...
            Method (P6XH, 2, NotSerialized)
            {
                ...
                If ((Arg0 == 0x00))
                {
                    DBGP = ((DBGP & 0xFFFFFF00) | Arg1)
                }

                If ((Arg0 == 0x01))
                {
                    DBGP = ((DBGP & 0xFFFF00FF) | (Arg1 << 0x08))
                }

                If ((Arg0 == 0x02))
                {
                    DBGP = ((DBGP & 0xFF00FFFF) | (Arg1 << 0x10))
                }

                If ((Arg0 == 0x03))
                {
                    DBGP = ((DBGP & 0x00FFFFFF) | (Arg1 << 0x18))
                }

                Sleep (0x64)
                P62H = DBGP /* \_SB_.PCI0.LPCB.EC__.P6XH.DBGP */
            }
            ...
            Device (HKEY)
            {
                ...
                Method (_INI, 0, NotSerialized)  // _INI: Initialize
                {
                    ADBG ("HKEY _INI")
                    ADBG ("_INI0")
                    \_SB.PCI0.LPCB.EC.HKEY.ANDN = 0x00
            ...
            OperationRegion (BCMS, SystemIO, 0x72, 0x02)
            Field (BCMS, ByteAcc, NoLock, Preserve)
            {
                CIND,   8, 
                CDAT,   8
            }
        ...
        Device (MOU)
        {
            Name (_HID, EisaId ("LEN005F"))  // _HID: Hardware ID
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        If (((Arg0 == 0x03) || (Arg0 == 0x04)))
        {
            \_SB.PCI0.MLTR = \_SB.PCI0.PEG0.PEGP.HDAS /* External reference */
            If (\LNUX)
            {
                \_SB.PCI0.MLTR = One
            }
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (_INI, 0, Serialized)  // _INI: Initialize
        {
            ...
            If (CondRefOf (\_OSI))
            {
                ...
                If (\_OSI ("Linux-Lenovo-NvidiaAudio"))
                {
                    \LNUX = 0x01
                }
            }
        ...
        Method (_L61, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
            If (\_SB.PCI0.RP01.HPSX)
            {
                ...
                If (\_SB.PCI0.RP01.PDCX)
                {
                    ...
                    \_SB.PCI0.RP01.PDSF = \_SB.PCI0.RP01.PDSX
                    Notify (\_SB.PCI0.RP01, 0x00) // Bus Check
                }
            }

            If (\_SB.PCI0.RP05.HPSX)
            {
                Sleep (0x64)
    ...
    OperationRegion (MNVS, SystemMemory, 0x99560018, 0x1000)
    ...
    Scope (\_SB.PCI0.LPCB)
    {
        ...
        OperationRegion (GDIO, SystemMemory, 0xFDAE04C0, 0x10)
    ...
    Scope (\_SB.PCI0.LPCB.EC)
    {
        ...
        Method (_Q26, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
        {
            ...
            If ((\_SB.PCI0.LPCB.EC.CHGP == 0x00))
            {
                \_SB.PCI0.LPCB.EC.HKEY.DEVT (0xD1)
            }

            If (\VIGD){}
            Else
            {
                \_SB.PCI0.PEG0.MASP (0x00)
                \_SB.PCI0.PEG0.PEGP.MASP (0x00)
            }
        ...
        Method (_Q27, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
        {
            ...
            If ((\_SB.PCI0.LPCB.EC.CHGP == 0x00))
            {
                \_SB.PCI0.LPCB.EC.HKEY.DEVT (0xD3)
            }
        ...
        {
            Fatal (0x01, 0x80010000, 0x000111E6)
        }

        Method (_Q4E, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
        {
            \_SB.PCI0.LPCB.EC.CHGP = One
            \_SB.PCI0.LPCB.EC.HKEY.DEVT (0xD5)
        }

        Method (_Q4F, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
        {
            \_SB.PCI0.LPCB.EC.CHGP = Zero
            If ((\_SB.PCI0.LPCB.EC.AC._PSR () == 0x01))
            {
                \_SB.PCI0.LPCB.EC.HKEY.DEVT (0xD1)
            }
            Else
        ...
        Scope (\_SB.PCI0.LPCB.EC)
        {
            ...
            Method (NBRE, 1, NotSerialized)
            {
                If ((Arg0 < 0x0C))
                {
                    ...
                    Else
                    {
                        Notify (\_SB.PCI0.SAT0.PRT3, 0x03) // Eject Request
                    }
                }
            }
            ...
            Method (NBEJ, 1, NotSerialized)
            {
                If ((BSTS == 0x00))
                {
                    If ((Arg0 < 0x0C))
                    {
                        ...
                        Else
                        {
                            Notify (\_SB.PCI0.SAT0.PRT3, 0x01) // Device Check
                        }
                    }
                }
    ...
    Scope (\_SB.PCI0.LPCB.EC.HKEY)
    {
        ...
        Method (FANI, 0, NotSerialized)
        {
            Name (RETN, 0x00)
            RETN |= \FSPT
            RETN |= (\FANE << 0x08)
            Return (RETN) /* \_SB_.PCI0.LPCB.EC__.HKEY.FANI.RETN */
        }
        ...
        Method (NVST, 1, Serialized)
        {
            ...
            Switch (Local0)
            {
                Case (0x04)
                {
                    If ((((\NVID == 0x1BB810DE) || (\NVID == 0x1BB710DE)) || (\NVID == 0x1BB610DE)))
                    {
                        Local1 = (0x4B + 0x0E)
                    }
                    Else
                    ...
                    \_SB.PCI0.LPCB.EC.HKEY.GPTL = Local1
                }
                Case (0x07)
                {
                    If ((((\NVID == 0x1BB810DE) || (\NVID == 0x1BB710DE)) || (\NVID == 0x1BB610DE)))
                ...
                Case (0x00)
                {
                    ...
                    ElseIf ((\NVID == 0x13B410DE))
                    {
                        Local1 = 0x63
                    }
                    ElseIf (((\NVID == 0x13B610DE) || (\NVID == 0x143610DE)))
                    {
                        Local1 = 0x63
                    }
            ...
            If ((ANGN && (\_SB.GGOV (0x01060016) == 0x01)))
            {
        ...
        Method (DEVT, 1, Serialized)
        {
            If ((\_SB.PCI0.LPCB.EC.HKEY.ANDN && (\_SB.GGOV (0x01060016) == 0x01)))
            {
                If (((OSYS > 0x07D9) && PEGS ()))
                {
                    If ((SGMD == 0x02))
                    {
                        While ((\_SB.PCI0.PEG0.DGIZ == Zero))
                        {
                            Sleep (0x0A)
                        }
                    }
                ...
                Notify (\_SB.PCI0.PEG0.PEGP, Arg0)
                \_SB.PCI0.LPCB.EC.BVPC = One
            }
        }
    }
